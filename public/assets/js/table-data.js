var TableData = function () {
    ...
    var runDataTable = function () {
        ...
        $('#sample_1_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "Tìm kiếm nhanh...");
    ...
    var runEditableTable = function(){
		...
		function saveRow(oTable, nRow) {
			...
			oTable.fnUpdate('<a class="edit-row" href="">Sửa</a>', nRow, 3, false);
			oTable.fnUpdate('<a class="delete-row" href="">Xóa</a>', nRow, 4, false);
			oTable.fnDraw();
			newRow = false;
		...
		$('#sample_2_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "Tìm kiếm nhanh...");
		// modify table search input
